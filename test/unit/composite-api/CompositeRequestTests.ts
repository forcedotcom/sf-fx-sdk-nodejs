...
describe('CompositeRequest Tests', () => {
    let compositeRequest:sfxif.ICompositeRequest = null;

    beforeEach(function() {
        compositeRequest = index.compositeApi.newCompositeRequest();
    });
    ...
    it('addSubrequest/getSubrequests with sObjectType', () => {
        const compositeSubRequest1:sfxif.ICompositeSubrequest = index.compositeApi.insertBuilder().sObjectType('Account').build();
        const compositeSubRequest2:sfxif.ICompositeSubrequest = index.compositeApi.insertBuilder().sObjectType('Account').build();
        compositeRequest.addSubrequest(compositeSubRequest1);
        compositeRequest.addSubrequest(compositeSubRequest2);

        const compositeSubrequests:ReadonlyArray<sfxif.ICompositeSubrequest> = compositeRequest.subrequests;
    ...
    it('addSubrequest/getSubrequests with sObject', () => {
        ...
        const compositeSubRequest1:sfxif.ICompositeSubrequest = index.compositeApi.insertBuilder().sObject(account).build();
        const compositeSubRequest2:sfxif.ICompositeSubrequest = index.compositeApi.insertBuilder().sObject(account).build();
        compositeRequest.addSubrequest(compositeSubRequest1);
        compositeRequest.addSubrequest(compositeSubRequest2);
    ...
    it('addSubrequest/getSubrequest by reference id', () => {
        ...
        const foundSubrequest1:sfxif.ICompositeSubrequest = compositeRequest.getSubrequest(compositeSubRequest1.referenceId);
        expect(foundSubrequest1).to.exist;
        expect(foundSubrequest1).to.equal(compositeSubRequest1);

        const foundSubrequest2:sfxif.ICompositeSubrequest = compositeRequest.getSubrequest(compositeSubRequest2.referenceId);
    ...
    it('Insert and Patch have different reference ids', () => {
        ...
        const compositeSubRequestInsert:sfxif.ICompositeSubrequest = index.compositeApi.insertBuilder().sObject(account).build();
        const compositeSubRequestPatch:sfxif.ICompositeSubrequest = index.compositeApi.patchBuilder().sObject(account).build();
    ...
    it('Insert and Put have different reference ids', () => {
        ...
        const compositeSubRequestInsert:sfxif.ICompositeSubrequest = index.compositeApi.insertBuilder().sObject(account).build();
        const compositeSubRequestPut:sfxif.ICompositeSubrequest = index.compositeApi.patchBuilder().sObject(account).build();
